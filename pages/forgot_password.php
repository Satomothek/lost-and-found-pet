...
<head>
    ...
    <title>Lupa Sandi | PetFounds</title>
    ...
    <main class="auth-layout">
        <div class="auth-card">
            ...
            <p class="text-center text-muted" style="margin-bottom: 35px;">
                Masukkan email Anda untuk menerima link pemulihan sandi.
            </p>

            <form id="forgot-password-form">
                <div class="input-modern">
                    <i class="fa-regular fa-envelope"></i>
                    <input type="email" id="forgot-email" placeholder="Alamat Email" required>
                </div>
            ...
            <p class="text-center text-muted" style="margin-top: 25px; font-size: 0.9rem;">
                Ingat sandi Anda? <a href="login.php" class="text-primary font-bold">Masuk</a>
            </p>
        </div>
    </main>

    <script src="../public/js/utils.js"></script>
    <script src="../public/js/pages/forgot_password.js"></script>
</body>
</html>
