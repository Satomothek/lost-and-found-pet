...
if ($method === 'GET' && !$action) {
    ...
    $userData = [
        ...
        'name' => $user['name'],
        'email' => $user['email'],
        'avatar' => $user['avatar_url'] ? normalizeAssetUrl($user['avatar_url']) : generateAvatarUrl($user['name']),
        'bio' => $user['bio'] ?? '',
        'phone' => $user['phone'] ?? '',
...
elseif ($method === 'GET' && $action === 'reports') {
    ...
    $reports = array_map(function($report) {
        return [
            ...
            'authorImg'            => $report['author_avatar'] ? normalizeAssetUrl($report['author_avatar']) : generateAvatarUrl($report['author_name'] ?: 'Anonim'),
